...
class TestFormattedTimeAndDate:
  ...
  def test___init__(self):
    ...
    with pytest.raises(IncorrectFormatedDateAndTime):
    ...
    with pytest.raises(IncorrectFormatedDateAndTime):
      assert FormattedTimeAndDate("22/04/2022", 61, 58), "The formatted time class accepted more than 60 in the hour parameter."
    ...
    with pytest.raises(IncorrectFormatedDateAndTime):
      assert FormattedTimeAndDate("22/04/2022", -1, 58), "The formatted time class accepted less than 0 in the hour parameter"
    ...
    with pytest.raises(IncorrectFormatedDateAndTime):
      assert FormattedTimeAndDate("22/04/2022", 16, 61), "The formatted time class accepted more than 60 in the minutes parameter."
    ...
    with pytest.raises(IncorrectFormatedDateAndTime):
      assert FormattedTimeAndDate("22/04/2022", 16, -1), "The formatted time class accepted less than 0 in the minutes parameter"
